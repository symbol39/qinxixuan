...
(function () {
  var pools = {
    ...
    event: ["失竊案", "連續失蹤事件", "祭典騷動", "神秘瘟疫", "遺跡崩塌", "商隊遇襲", "叛亂徵兆", "詛咒蔓延", "怪物入侵", "秘密結社集會", "繼承權糾紛", "禁忌儀式", "邊境衝突", "礦坑坍塌", "亡靈騷動", "連續殺人事件", "魔法失控", "詭異的天象", "群架", "攻城", "圍城", "召喚出惡魔的儀式", "召喚出不死生物的儀式", "召喚出怪物的儀式", "召喚出異界生物的儀式", "夫妻吵架", "魔法師的爭辯", "一群學者正在爭辯", "魔法實驗成功", "魔法實驗失敗"],
